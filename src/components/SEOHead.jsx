...
const seoDataMap = {
  ...
  '/guias': {
    ...
    description: 'Aprende a ahorrar en luz y gas: consejos prácticos para facturas domésticas, tarifas para empresas, autoconsumo en comunidades y placas solares.',
    canonical: 'https://tu-luz.es/guias'
  },
  '/guias/ahorrar-factura-de-la-luz': {
    title: 'Cómo Ahorrar en la Factura de la Luz en 2026: 10 Claves | tuLuz',
    description: 'Descubre las 10 claves reales y contrastadas para ahorrar en la factura de la luz hasta un 35%: ajuste de potencia (kW), tramos 2.0TD, tarifas y hábitos.',
