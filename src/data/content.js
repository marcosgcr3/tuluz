...
export const providersList = [
  { name: "Endesa", domain: "endesa.com", logo: "/logos/endesa.webp" },
  { name: "Iberdrola", domain: "iberdrola.es", logo: "/logos/iberdrola.webp" },
  { name: "Naturgy", domain: "naturgy.es", logo: "/logos/naturgy.webp" },
  { name: "Repsol", domain: "repsol.es", logo: "/logos/repsol.webp" },
  { name: "TotalEnergies", domain: "totalenergies.es", logo: "/logos/totalenergies.webp" },
  { name: "Plenitude", domain: "eniplenitude.es", logo: "/logos/plenitude.webp" },
  { name: "Audax Renovables", domain: "audaxrenovables.com", logo: "/logos/audax.webp" },
  { name: "HolaLuz", domain: "holaluz.com", logo: "/logos/holaluz.webp" },
  { name: "GNS Energy", domain: "gnsenergy.es", logo: "/logos/gns-energy.svg" },
  { name: "Fenie Energía", domain: "fenieenergia.es", logo: "/logos/fenie.webp" },
  { name: "Octopus Energy", domain: "octopusenergy.es", logo: "/logos/octopus.webp" },
  { name: "Lucera", domain: "lucera.es", logo: "/logos/lucera.svg" },
  { name: "Imagenerat", domain: "imagenerat.es", logo: "/logos/imagenerat.svg" },
  { name: "EnergyAV", domain: "energyav.es", logo: "/logos/energyav.svg" },
  { name: "Factor Energía", domain: "factorenergia.com", logo: "/logos/factorenergia.webp" },
  { name: "Gana Energía", domain: "ganaenergia.com", logo: "/logos/gana-energia.webp" },
  { name: "Mega Energía", domain: "megaenergia.es", logo: "/logos/mega-energia.webp" },
  { name: "Novaluz Energía", domain: "novaluz.es", logo: "/logos/novaluz.webp" },
  { name: "Net Energy", domain: "net-energia.es", logo: "/logos/net-energy.svg" },
  { name: "Kleen Energy", domain: "kleenenergy.es", logo: "/logos/kleen-energy.webp" },
  { name: "Unieléctrica", domain: "unielectrica.com", logo: "/logos/unielectrica.webp" },
  { name: "Ibereléctrica Energía", domain: "iberelectrica.es", logo: "/logos/iberelectrica.webp" }
];
...
export const servicesOverview = [
  {
    ...
    icon: "Building2",
    image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=400&q=60&fm=webp",
  ...
  },
  {
    ...
    icon: "Users",
    image: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=400&q=60&fm=webp",
  ...
  },
  {
    ...
    icon: "Home",
    image: "https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&w=400&q=60&fm=webp",
