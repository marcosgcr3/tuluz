...
export const guidesData = [
  {
    ...
    "metaTitle": "Cómo Ahorrar en la Factura de la Luz en 2026: 10 Claves | tuLuz",
    "metaDescription": "Descubre las 10 claves reales y contrastadas para ahorrar en la factura de la luz hasta un 35%: ajuste de potencia (kW), tramos 2.0TD, tarifas y hábitos.",
    ...
    "excerpt": "Reducir el importe de tu recibo eléctrico no significa pasar frío o prescindir del confort. Conoce las 10 claves técnicas y prácticas más efectivas para recortar hasta un 35% mensual.",
    "tableOfContents": [
      {
        "id": "anatomia-factura",
      ...
      {
        "id": "clave-1-potencia",
        "title": "Clave 1: Ajusta la potencia contratada (término fijo en kW)"
      },
      {
        "id": "clave-2-tramos",
        "title": "Clave 2: Aprovecha los 3 tramos horarios de la tarifa 2.0TD"
      },
      {
        "id": "clave-3-tarifa",
        "title": "Clave 3: Elige la modalidad adecuada (precio fijo vs indexado)"
      },
      {
        "id": "clave-4-servicios",
        "title": "Clave 4: Elimina servicios de mantenimiento y seguros innecesarios"
      },
      {
        "id": "clave-5-standby",
        "title": "Clave 5: Erradica el consumo fantasma (stand-by) con regletas"
      },
      {
        "id": "clave-6-climatizacion",
        "title": "Clave 6: Fija el termostato en 21°C en invierno y 25°C en verano"
      },
      {
        "id": "clave-7-frigorifico",
        "title": "Clave 7: Regula y mantén el frigorífico a 4°C y el congelador a -18°C"
      },
      {
        "id": "clave-8-lavados",
        "title": "Clave 8: Lava a baja temperatura (30°C) y usa programas ECO"
      },
      {
        "id": "clave-9-led",
        "title": "Clave 9: Sustituye el 100% de la iluminación por bombillas LED"
      },
      {
        "id": "clave-10-autoconsumo",
        "title": "Clave 10: Valora el autoconsumo solar con batería virtual"
      },
      {
        "id": "tabla-resumen-ahorro",
        "title": "Tabla comparativa: impacto real de ahorro anual de cada clave"
      },
      {
        "id": "preguntas-frecuentes",
        "title": "Preguntas frecuentes sobre cómo ahorrar en la factura"
      }
    ],
    "sections": [
      {
      ...
      {
        "id": "clave-1-potencia",
        "title": "Clave 1: Ajusta la potencia contratada (término fijo en kW) según tus picos reales",
      ...
      {
        "id": "clave-2-tramos",
        "title": "Clave 2: Conoce y aprovecha los 3 tramos horarios de la tarifa 2.0TD",
        ...
        "table": {
          ...
          "rows": [
            [
              ...
              "El más caro",
              "Evitar horno, lavadora, secadora y plancha"
            ],
            [
              "Llano (P2)",
              "08:00 - 10:00, 14:00 - 18:00 y 22:00 - 00:00",
              "Coste intermedio",
              "Uso habitual, cocina diaria y teletrabajo"
            ],
            [
              "Valle (P3)",
              "00:00 - 08:00 + Fines de semana y festivos 24h",
              "El más barato",
              "Programar lavavajillas, lavadora, termo y recarga de vehículo eléctrico"
            ]
          ]
        }
      },
      {
        "id": "clave-3-tarifa",
        "title": "Clave 3: Elige la modalidad adecuada (precio fijo vs indexado al mercado)",
      ...
      {
        "id": "clave-4-servicios",
        "title": "Clave 4: Elimina servicios de mantenimiento y seguros de pago innecesarios",
      ...
      {
        "id": "clave-5-standby",
        "title": "Clave 5: Erradica el consumo en reposo (stand-by o consumo fantasma) con regletas",
      ...
      {
        "id": "clave-6-climatizacion",
        "title": "Clave 6: Fija el termostato de climatización en 21°C en invierno y 25°C en verano",
      ...
      {
        "id": "clave-8-lavados",
        "title": "Clave 8: Lava a baja temperatura (30°C o frío) y usa programas ECO",
      ...
      {
        "id": "clave-9-led",
        "title": "Clave 9: Sustituye el 100% de la iluminación por bombillas LED de alta eficiencia",
      ...
      {
        "id": "clave-10-autoconsumo",
        "title": "Clave 10: Valora el autoconsumo solar fotovoltaico con batería virtual",
      ...
      },
      {
        "id": "tabla-resumen-ahorro",
        "title": "Tabla comparativa: impacto real de ahorro anual de cada clave",
        "content": "Resumen acumulado del impacto económico estimado que puedes conseguir aplicando estas 10 claves en tu vivienda:",
        "table": {
          "headers": [
            "Nº",
            "Clave de Ahorro",
          ...
          "rows": [
            [
              "1",
              "Ajustar la potencia contratada (kW)",
              "45€ - 80€ / año",
              "Muy fácil (gestión de trámite)"
            ],
            [
              "2",
              "Aprovechar los tramos horarios 2.0TD",
              "60€ - 130€ / año",
              "Media (adaptación de hábitos)"
            ],
            [
              "3",
              "Elegir tarifa competitiva (fija o indexada)",
              "90€ - 220€ / año",
              "Fácil (asesoramiento tuLuz)"
            ],
            [
              "4",
              "Eliminar seguros y mantenimientos ocultos",
              "60€ - 180€ / año",
              "Muy fácil (baja de servicio)"
            ],
            [
              "5",
              "Eliminar consumo fantasma (stand-by)",
              "30€ - 60€ / año",
              "Fácil (regletas con interruptor)"
            ],
            [
              "6",
              "Optimizar climatización (21°C invierno / 25°C verano)",
              "80€ - 160€ / año",
              "Fácil (ajuste de termostato)"
            ],
            [
              "7",
              "Regulación de frigorífico (4°C / -18°C)",
              "25€ - 50€ / año",
              "Muy fácil (ajuste de ruleta/display)"
            ],
            [
              "8",
              "Lavados a baja temperatura (30°C / ECO)",
              "35€ - 70€ / año",
              "Fácil (selección de programa)"
            ],
            [
              "9",
              "Migración integral a iluminación LED",
              "40€ - 80€ / año",
              "Fácil (cambio de bombillas)"
            ],
            [
              "10",
              "Instalación de paneles solares + batería virtual",
              "450€ - 1.100€ / año",
              "Media-Alta (instalación técnica)"
            ]
          ]
        }
      }
    ...
    "faqs": [
      {
        "q": "¿Cuál es la primera clave que debería aplicar para notar un ahorro rápido?",
    ...
    "tableOfContents": [
      {
        ...
        "title": "1. Tipos de tarifas y peajes para empresas (2.0TD, 3.0TD, 6.XTD)"
      },
      {
        "id": "penalizaciones-maximetro",
        "title": "2. Penalizaciones por exceso de potencia y maxímetro"
      },
      {
        "id": "energia-reactiva",
        "title": "3. El recargo de la energía reactiva: causas y solución"
      },
      {
        "id": "modalidades-fija-indexada",
        "title": "4. Modalidades de contratación: ¿Fija, Indexada o PPA?"
      },
      {
        "id": "curva-carga-cuartohoraria",
        "title": "5. Análisis y negociación con la curva de carga cuartohoraria"
      },
      {
        "id": "caso-practico-pyme",
        "title": "6. Caso real de optimización: 31% de ahorro en pyme"
      },
      {
        "id": "preguntas-frecuentes",
        "title": "Preguntas frecuentes sobre tarifas de luz para empresas"
      }
    ],
    "sections": [
      {
      ...
      },
      {
        ...
        "table": {
          ...
          "rows": [
            [
              "Precio Fijo",
              "Presupuesto cerrado sin sorpresas durante 12-24 meses.",
              "Precios habitualmente más altos con primas de riesgo de la comercializadora.",
              "Empresas con márgenes estrictos que no pueden tolerar volatilidad."
            ],
            [
              "Indexada al Pool (OMIE)",
              "Sin prima de cobertura comercial. Aprovecha precios mínimos en horas solares.",
              "Sensibilidad a subidas puntuales del mercado mayorista.",
              "Empresas con capacidad de desplazar consumo a horas centrales o nocturnas."
            ],
            [
              "Mixta / Con Coberturas (PPA)",
              "Bloqueo de un % de consumo a precio fijo y el resto a mercado indexado.",
              "Requiere asesoramiento técnico profesional continuado.",
              "Empresas medianas y grandes con consumos superiores a 100 MWh/año."
            ]
          ]
        }
      },
  ...
  },
  {
    ...
    "tableOfContents": [
      {
        "id": "marco-normativo",
        "title": "1. Marco legal: Real Decreto 244/2019 y Ley de Propiedad Horizontal"
      },
      {
        "id": "mayorias-junta",
        "title": "2. ¿Qué mayoría se necesita en junta de propietarios?"
      },
      {
        "id": "modelos-autoconsumo",
        "title": "3. Modelos: zonas comunes vs reparto entre vecinos"
      },
      {
        "id": "coeficientes-reparto",
        "title": "4. Coeficientes de reparto (parámetros Beta)"
      },
      {
        "id": "ayudas-subvenciones",
        "title": "5. Subvenciones, deducción en IRPF e IBI"
      },
      {
        "id": "pasos-proyecto",
      ...
      {
        "id": "preguntas-frecuentes",
        "title": "Preguntas frecuentes en comunidades de vecinos"
      }
    ],
    "sections": [
      {
      ...
      },
      {
        ...
        "table": {
          "headers": [
            ...
            "Mayoría requerida en Junta",
            "Distribución del coste",
            "Vecinos no participantes"
          ],
          "rows": [
            [
              "Exclusivo para zonas comunes (ascensor, luces, garaje)",
              "Mayoría simple (voto favorable de la mayoría de propietarios que representen la mayoría de cuotas).",
              "Se reparte entre todos los propietarios según cuota de participación.",
              "Obligados al pago si el coste repercutido no supera doce mensualidades ordinarias."
            ],
            [
              "Uso privativo individual (solo para vecinos interesados)",
              "Un tercio (1/3) de los integrantes de la comunidad que representen un tercio de las cuotas de participación.",
              "Asumido exclusivamente por los vecinos que voluntariamente se adhieran.",
              "No pagan nada y no disfrutan de la energía generada."
            ]
          ]
        },
        "callout": {
    ...
    "tableOfContents": [
      {
        ...
        "title": "1. Diferencia fundamental entre comercializadora y distribuidora"
      },
      {
        "id": "mercado-libre-vs-regulado",
        "title": "2. Mercado Libre vs Mercado Regulado (PVPC y TUR)"
      },
      {
        "id": "trampas-habituales",
        "title": "3. Las 5 trampas habituales de las ofertas gancho"
      },
      {
        "id": "tarifas-duales",
        "title": "4. Tarifas duales (luz + gas): ¿conviene unificarlas?"
      },
      {
        "id": "por-que-comparadores-sesgados",
        "title": "5. La verdad sobre los comparadores online convencionales"
      },
      {
        "id": "checklist-comparativa",
        "title": "6. Checklist para evaluar una oferta energética"
      },
      {
        "id": "preguntas-frecuentes",
        "title": "Preguntas frecuentes en comparativas"
      }
    ],
    "sections": [
      {
      ...
      },
      {
        ...
        "table": {
          "headers": [
            "Concepto",
            "Mercado Regulado (PVPC en luz / TUR en gas)",
            "Mercado Libre (+300 comercializadoras)"
          ],
          "rows": [
            [
              "Fijación de precios",
              "Regulados por el Gobierno y fórmulas oficiales del BOE.",
              "Libremente pactados entre la comercializadora y el cliente."
            ],
            [
              "Bono Social",
              "Obligatorio para solicitar el Bono Social Eléctrico o Térmico.",
              "No disponible (salvo excepciones normativas puntuales)."
            ],
            [
              "Permanencia",
              "Prohibida por ley (0 permanencia).",
              "Generalmente sin permanencia en contratos residenciales, aunque algunas empresas la imponen si no se revisa el contrato."
            ],
            [
              "Servicios adicionales",
              "Prohibido añadir seguros de averías o mantenimientos.",
              "Permitido (frecuente foco de sobrecostes si no se rechazan expresamente)."
            ]
          ]
        },
        "callout": {
  ...
  },
  {
    ...
    "excerpt": "Desglosamos al detalle cuánto cuesta poner placas solares en una vivienda particular en 2026: desglose de materiales, retorno de la inversión, deducciones de hasta el 60% en IRPF y batería virtual para factura a 0€.",
    "tableOfContents": [
      {
        "id": "tabla-precios-2026",
        "title": "1. ¿Cuánto cuesta instalar placas solares en 2026?"
      },
      {
        "id": "las-6-partidas-coste",
        "title": "2. Desglose detallado: qué incluye un presupuesto solar"
      },
      {
      ...
      },
      {
        ...
        "title": "6. Deducciones de IRPF, bonificaciones de IBI y ventajas fiscales"
      },
      {
        "id": "preguntas-frecuentes",
        "title": "Preguntas frecuentes sobre placas solares"
      }
    ],
    "sections": [
      {
        ...
        "table": {
          "headers": [
            "Tipo de vivienda / Consumo mensual",
            "Potencia pico",
            "Nº estimado paneles (500W)",
            "Rango de precio medio (IVA incluido)"
          ],
          "rows": [
            [
              "Piso / Adosado pequeño (hasta 50€/mes factura)",
              "2,5 kWp - 3 kWp",
              "5 - 6 paneles",
              "3.200€ - 4.100€"
            ],
            [
              "Vivienda unifamiliar media (60€ - 120€/mes)",
              "4 kWp - 5 kWp",
              "8 - 10 paneles",
              "4.400€ - 5.600€"
            ],
            [
              "Vivienda grande / Aerotermia (+150€/mes)",
              "6 kWp - 8 kWp",
              "12 - 16 paneles",
              "6.200€ - 7.900€"
            ],
            [
              "Vivienda con piscina climatizada y coche eléctrico",
              "8 kWp - 10 kWp",
              "16 - 20 paneles",
              "7.800€ - 9.800€"
            ]
      ...
      },
      {
        ...
        "content": "Un presupuesto fotovoltaico profesional no es solo comprar paneles; comprende todos los elementos técnicos y administrativos:",
        "bullets": [
          "**Módulos fotovoltaicos Tier 1:** Paneles monocristalinos de alta eficiencia con 25 a 30 años de garantía de producción (representan el 25% - 30% del presupuesto).",
          "**Inversor solar o microinversores:** El equipo que transforma la corriente continua de las placas en corriente alterna para tu hogar (marcas como Huawei, Enphase, Sungrow, Fronius), con un 20% - 25% del coste.",
          "**Estructuras de anclaje:** Estructuras de aluminio anodizado coplanares o con inclinación certificadas para resistir vientos superiores a 120 km/h (10% - 12% del coste).",
          "**Cuadro de protecciones eléctricas y cableado:** Magnetotérmicos, sobretensiones transitorias y permanentes y cableado solar de doble aislamiento (8% - 10% del coste).",
          "**Mano de obra e instalación autorizada:** Técnicos montadores e instaladores electricistas homologados con seguro de responsabilidad civil (15% - 20% del coste).",
          "**Legalización, tasas y boletín (CIE):** Proyecto o memoria técnica, pago de tasas municipales, boletín eléctrico y registro ante Industria y distribuidora (8% - 12% del coste)."
        ]
      },
      {
        "id": "cuantos-paneles-necesitas",
      ...
      {
        "id": "deducciones-irpf-ibi",
        "title": "6. Deducciones de IRPF, bonificaciones de IBI y ventajas fiscales en 2026",
